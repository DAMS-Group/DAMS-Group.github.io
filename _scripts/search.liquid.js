          ...
          {%- unless child.title == 'divider' -%}
            {
              ...
              {%- if child.permalink contains "/book/" -%}{%- assign url = "/book/" -%} {%- else -%}{%- assign url = child.permalink -%}{%- endif -%}
      ...
      {%- else -%}
        {
          ...
          {%- if p.permalink contains "/book/" -%}{%- assign url = "/book/" -%} {%- else -%}{%- assign url = p.url -%}{%- endif -%}
