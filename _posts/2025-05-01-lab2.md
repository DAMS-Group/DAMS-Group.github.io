...
<div style="text-align: center;">
    <img alt="CPUID-desc" src="/assets/img/book/chapter2/exp3/CPUID-desc.png" width="70%" style="margin-top: 10px; margin-bottom: 10px" />
</div>
...
<div style="text-align: center;">
    <img alt="ia-32" src="/assets/img/book/chapter2/exp3/ia-32.png" width="70%" style="margin-top: 10px; margin-bottom: 10px" />
</div>
...
<div style="text-align: center;">
    <img alt="CPUinfo-guest" src="/assets/img/book/chapter2/exp3/CPUinfo-guest.png" width="70%" style="margin-top: 10px; margin-bottom: 10px" />
</div>
...
<div style="text-align: center;">
    <img alt="modify-cpuid-model-test" src="/assets/img/book/chapter2/exp3/modify-cpuid-model-test.png" width="70%" style="margin-top: 10px; margin-bottom: 10px" />
</div>
