...
<div style="text-align: center;">
    <img src="/assets/img/book/chapter3/exp1/1679042004764.png" width="70%" style="margin-top: 10px; margin-bottom: 10px" />
</div>
...
```c
	...
	for(i = 0; i < KVM_EPTP_NUMBERS; i++){
		if((eptp >> PAGE_SHIFT) == ((mmu->new_root_hpa[i]) >> PAGE_SHIFT)){
			...
			printk("[ept_violation]: Current eptp = 0x%llx\n", eptp);
...
<div style="text-align: center;">
    <img alt="vmfunc_thread" src="/assets/img/book/chapter3/exp2/vmfunc_thread.png" width="70%" style="margin-top: 10px; margin-bottom: 10px" />
</div>
...
<div style="text-align: center;">
    <img alt="balloon inflate page" src="/assets/img/book/chapter3/exp3/balloon_inflate_page.png" width="70%" style="margin-top: 10px; margin-bottom: 10px" />
</div>
...
<div style="text-align: center;">
    <img alt="balloon deflate guest" src="/assets/img/book/chapter3/exp3/balloon_deflate_guest.png" width="70%" style="margin-top: 10px; margin-bottom: 10px" />
</div>
