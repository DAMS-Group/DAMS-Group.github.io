...
<div style="text-align: center;">
    <img alt="exp1" src="/assets/img/book/chapter4/exp1.png" width="70%" style="margin-top: 10px; margin-bottom: 10px" />
</div>
...
<div style="text-align: center;">
    <img alt="exp2-1" src="/assets/img/book/chapter4/exp2-1.png" width="70%" style="margin-top: 10px; margin-bottom: 10px" />
</div>

部分dmesg输出如下：

<div style="text-align: center;">
    <img alt="exp2-2" src="/assets/img/book/chapter4/exp2-2.png" width="70%" style="margin-top: 10px; margin-bottom: 10px" />
</div>
...
<div style="text-align: center;">
    <img src="/assets/img/book/chapter4/exp3.png" width="70%" style="margin-top: 10px; margin-bottom: 10px" />
</div>
