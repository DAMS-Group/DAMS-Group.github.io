...
<div style="text-align: center;">
    <img alt="add-irq-num10" src="/assets/img/book/chapter5/exp1/add-irq-num10.png" width="80%" style="margin-top: 10px; margin-bottom: 10px" />
</div>

中断的处理

<div style="text-align: center;">
    <img alt="qemu-monitor" src="/assets/img/book/chapter5/exp1/qemu-monitor.png" width="80%" style="margin-top: 10px; margin-bottom: 10px" />
</div>

<div style="text-align: center;">
    <img alt="vm-dmesg" src="/assets/img/book/chapter5/exp1/vm-dmesg.png" width="80%" style="margin-top: 10px; margin-bottom: 10px" />
</div>

内核输出

<div style="text-align: center;">
    <img alt="kvm-dmesg" src="/assets/img/book/chapter5/exp1/kvm-dmesg.png" width="80%" style="margin-top: 10px; margin-bottom: 10px" />
</div>
...
<div style="text-align: center;">
    <img alt="test-result" src="/assets/img/book/chapter5/exp2/test-result.png" width="80%" style="margin-top: 10px; margin-bottom: 10px" />
</div>

<div style="text-align: center;">
    <img alt="guest-dmesg" src="/assets/img/book/chapter5/exp2/guest-dmesg.png" width="80%" style="margin-top: 10px; margin-bottom: 10px" />
</div>
